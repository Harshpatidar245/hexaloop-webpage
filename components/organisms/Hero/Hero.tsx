    ...
    <section className="pt-28 pb-12 sm:pt-32 sm:pb-16 md:pt-40 md:pb-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1 px-2 sm:px-0">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-4 sm:mb-5 md:mb-6">
              ...
              <span className="text-[#5EBEEB]">mobile design</span>
            </h1>
              ...
              <div className="relative z-10 bg-[#FF8C6B] rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-2xl transform hover:scale-105 transition-transform duration-300">
                <div className="aspect-video bg-[#FFE5D9] rounded-lg p-4 relative overflow-hidden">
                  ...
                  <svg className="w-full h-full" viewBox="0 0 200 150">
                    ...
                    <path d="M40,80 L80,40 L120,60 L160,30" stroke="#FF6B6B" strokeWidth="3" fill="none" />
                  </svg>
                </div>
        ...
        <div className="text-center mt-20 md:mt-32">
          ...
          {/* Client Logos */}
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 lg:gap-16 opacity-40">
            <div className="text-gray-400 text-2xl md:text-3xl font-light flex items-center gap-2">
              <span className="inline-block w-8 h-8 border-2 border-current rounded-full"></span>
              <span className="font-normal tracking-wide">SLOWAVE</span>
            </div>
            
            <div className="text-gray-400 text-2xl md:text-3xl font-light flex items-center gap-2">
              <span className="inline-block w-8 h-8 bg-current rounded-full flex items-center justify-center text-white text-sm">K</span>
              <span className="italic">eepsake</span>
            </div>
            
            <div className="text-gray-400 text-2xl md:text-3xl font-light tracking-wide">
              Skybox
            </div>
            
            <div className="text-gray-400 text-2xl md:text-3xl font-light">
              [ braille ]
            </div>
            
            <div className="text-gray-400 text-2xl md:text-3xl font-bold tracking-wide">
              Malory
            </div>
            
            <div className="text-gray-400 text-2xl md:text-3xl font-light">
              crea<span className="font-bold">;</span>tink
            </div>
          </div>
        </div>
      </div>
